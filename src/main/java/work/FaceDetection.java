...
public class FaceDetection extends DetectedFace {
    ...
    public FaceDetection() throws IOException {
        ...
        detectoreye = HaarCascadeDetector.BuiltInCascade.mcs_nose.load();
    ...
    public void detection(FImage imag) throws Exception {
        image1 = imag;
    ...
    public static void main(String[] args) throws Exception {
        ...
        fd.detection(ImageUtilities.readF(new File("/home/sergiu/NAO/10kuaNxI7kE.jpg")));
